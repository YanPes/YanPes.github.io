...
export const heroContent = {
  ...
  title: "Hi, I am ",
  accentName: 'Yannik.',
  role: 'I build engineering platforms that enable autonomous teams to move fast without architectural chaos.',
  roleExtended: 'Platform Engineering · AI Enablement · Engineering Governance · Developer Experience',
